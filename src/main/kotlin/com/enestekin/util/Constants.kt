...
object Constants {
 ...
 //  const val BASE_URL = "http://localhost:8001/"
  ...
  const val DEFAULT_PROFILE_PICTURE_PATH = "${BASE_URL}profile_pictures/avatar.jpg"
  const val DEFAULT_BANNER_IMAGE_PATH = "${BASE_URL}profile_pictures/defaultbanner.jpg"
